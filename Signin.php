...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/FirstPhp/aboutus.html" target="_blank" target="_blank">About Us</a>
      </li>
      <li class="nav-item">
...
<?php include_once("signincon.php"); ?>
...
<h1><i>Student Sign Up</i></h1>

<form name="myform" onsubmit="return Validateform()" class="was-validated" action="/FirstPhp/Signin.php" method="POST">
    <div class="form-group">
        <label for="name">Name</label>
        <i class="fa fa-user icon"></i>
        <input type="text" name="name" class="form-control" id="usrname" size="20" style="width: 500px;" required>
    </div>
    <div class="form-group">
                <label for="email">Xavier's Email Id </label>
                <i class="fa fa-envelope icon"></i>
                <input type="text" name="email" class="form-control" id="emid"  aria-describedby="emailHelp" placeholder="Enter xaviers.edu email id" size="30" style="width: 500px;" required>
                <small class="form-text text-muted" id="emailHelp">We'll never share your data with anyone else.</small>
            </div>
    <div class="form-group">
        <label for="pswd">Password</label>
        <i class="fa fa-key icon"></i>
        <input type="password" name="pswd" class="form-control" id="pswrd" placeholder="Enter uid as password" maxlength="6" style="width: 500px;" required>
    ...
    <div class="form-group">
      ...
      <label><span>Already Signed Up? Click Here</span></label> 
      <button class="btn btn-outline-dark btn-sm" onclick="Login()">Login</button><br><br>
      <label><span>Professor? Click Here</span></label> 
      <button class="btn btn-outline-dark btn-sm" onclick="LoginProf()">Login</button>
    </div>
    </form>
