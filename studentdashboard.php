...
<div class="row">
    <div class="card col-sm-2 mt-5 mr-3" id="rcorners" style="width: 10rem;text-align:center">
    <a href="http://localhost/FirstPhp/view.php" target="_blank">
...
<div class="card col-sm-2 mt-5" id="rcorners" style="width: 10rem;text-align:center">
    <a href="http://localhost/FirstPhp/view1.php" target="_blank">
